...
const Footer = () => {
    return (
        <div>
            <footer className="footer  p-10   bg-zinc-400 mt-4 text-base-content">
  <div>
...
<footer className="footer px-10 py-4 border-t  bg-slate-800  text-white border-base-300">
  <div className="items-center grid-flow-col">
    ...
    <p> SUMMER_SCHOOL <br/>Providing reliable tech since 1992</p>
  </div> 
